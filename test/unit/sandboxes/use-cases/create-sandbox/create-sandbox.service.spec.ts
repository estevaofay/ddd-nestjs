...
import { SandboxRepositoryPort } from '@src/sandboxes/infrastructure/database/sandbox';
...
describe('CreateSandboxService', () => {
  ...
  let repository: DeepMocked<SandboxRepositoryPort>;
  ...
  it('should create sandbox in runtime and persist it', async () => {
    // Given
    const dto: CreateSandboxRequestDto = {
      name: 'test-sandbox',
      services: [],
    };
    ...
    // When
    await service.createSandbox(dto);
